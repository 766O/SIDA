...
# python PIN_aug.py --dataset 'cityscapes' --data_root <CITYSCAPES_DIR> --save_dir <SAVE_DIR> --resize_feat --total_it 100 --domain_desc "driving at night."
...
def main():
    ...
    # target domain 종류 별로 폴더 생성
    #save_path = os.path.join(opts.save_dir,opts.domain_desc.replace(' ','_'))
